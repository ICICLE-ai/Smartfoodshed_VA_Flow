# Makefile for Visual Analytics Dashboard (front+back)
...
build: vars
	...
	@echo ""
	docker build -t va-backend:$$TAG backend/.
	@echo ""
	@echo "  🔨 : Building frontend image."
	@echo ""
	docker build -t va-frontend:$$TAG frontend/.
	@echo ""
